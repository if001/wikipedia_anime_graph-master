...
from wiki_relevance import gethtml
from wiki_relevance import getlink
#-------------------------------------------------------#
def set_vc(argv):
    # fname="cv_list.dat"

    fname = "./data/test_list.dat"
    fname = argv
    try :
        #句読点で区切られた名前をlistに格納
...
if __name__ == '__main__' :
    ...
    for i in range(matlen):
        ...
        if tmp_rel == -1 : #エラーがあれば表示
            ...
            linklist=getlink(tmp_rel)
            print("ok:",name[i],",link num:",len(linklist))
